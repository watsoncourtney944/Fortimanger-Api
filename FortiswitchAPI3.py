...
def get_fortiswitch_ports():
    ...
    try:
        response = requests.post(api_url, headers=headers, json=payload, verify=False, timeout=10) # sends an http post, includes headers for authentication and content type, sends the api request
...
# Call the function to see the parsed results
